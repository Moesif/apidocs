...
|status |string| false | One of active, cancelled, paused, trialing, pending, draft, future. This Manages the subscription status in Moesif such as blocking access to cancelled subscriptions.|
